# Scrapy settings for Sber_pars project
#
...
SPIDER_MODULES = ['Sber_pars.spiders']
NEWSPIDER_MODULE = 'Sber_pars.spiders'
...
#SPIDER_MIDDLEWARES = {
#    'Sber_pars.middlewares.SberParsSpiderMiddleware': 543,
#}
